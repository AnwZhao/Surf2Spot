...
from Surf2Spot.data.chainsaw.src import constants
from Surf2Spot.data.chainsaw.src.constants import _3to1
from Surf2Spot.data.chainsaw.src.utils.cif2pdb import cif2pdb
from Surf2Spot.data.chainsaw.src.utils.secondary_structure import renum_pdb_file, \
