...
def get_ProtTrans(ID_list, seq_list, Min_protrans, Max_protrans, ProtTrans_path, outpath, gpu, prottrans_model, prottrans_tokenizer):
    # Load the vocabulary and ProtT5-XL-UniRef50 Model
    tokenizer = prottrans_tokenizer
